 ...
 * runtime (`roleRunner.ts` has no such imports at all; `piConductor.ts` lazy-imports Pi only
 * inside {@link runIsolatedRoleViaPiSdk}). The real Pi extension entrypoint,
